...
{
    public class DataTypeLargeHelper : ITypeHelper<TestDataLarge_t>
    {
        protected TestDataLarge_t dataSample;
        ...
        {
            dataSample = new TestDataLarge_t();
            this.maxPerftestSampleSize = maxPerftestSampleSize;
        }

        public DataTypeLargeHelper(TestDataLarge_t dataSample, ulong maxPerftestSampleSize)
        {
            this.dataSample = dataSample;
            this.maxPerftestSampleSize = maxPerftestSampleSize;
        }

        public TestDataLarge_t MessageToSample(TestMessage message, int keyValue)
        {
        ...
        public TestMessage SampleToMessage(TestDataLarge_t data_sample)
        {
        ...
        {
            return new DataTypeLargeHelper(maxPerftestSampleSize);
        }

        public long GetSerializedOverheadSize() {
            using (var serializer = TestDataLarge_tSupport.Instance.CreateSerializer())
            {
